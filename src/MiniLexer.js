...
Object.defineProperty(MiniLexer.prototype, "atn", {
        get : function() {
                return atn;
        }
});
...
MiniLexer.T__37 = 38;
MiniLexer.ID = 39;
MiniLexer.INTEGER = 40;
MiniLexer.WS = 41;
MiniLexer.COMMENT = 42;

MiniLexer.prototype.channelNames = [ "DEFAULT_TOKEN_CHANNEL", "HIDDEN" ];

MiniLexer.prototype.modeNames = [ "DEFAULT_MODE" ];

MiniLexer.prototype.literalNames = [ null, "'struct'", "'{'", "'}'", "';'", 
                                     "'int'", "'bool'", "','", "'fun'", 
                                     "'('", "')'", "'void'", "'='", "'read'", 
                                     "'print'", "'endl'", "'if'", "'else'", 
                                     "'while'", "'delete'", "'return'", 
